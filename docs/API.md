...
Returns the active Edition and its complete public ranking projection, including `validVoteCount`
(VALID non-Skip community votes for that Edition). Equal scores receive the
