...
2026-08-30 Owner 去掉关于页「候选池」长文卡片，改由「灵感与数据」与「作者与开源」并排；「作者」和「灵感来源」不再当卡片标题，改成与「本项目已开源 / 数据支持」相同的标签加筹码。同日把 EWC 归档到新导航「往期赛事」（榜单式列表，点进后仍是原来的详细 MVP 表）；当期改为 BLAST Open Porto 2026（导航「当期赛事 - BLAST S2」），HLTV event 8249，规则与 EWC 相同（每日 +1、Top 10 加掉出保留、成绩来自官方奖金表）。
